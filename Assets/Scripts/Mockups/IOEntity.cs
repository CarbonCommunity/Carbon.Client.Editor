...
public class IOEntity : MonoBehaviour
{
	...
	public class IOType : MonoBehaviour
	{
	}

	public class IORef : MonoBehaviour
	{
	}

	public class IOSlot : MonoBehaviour
	{
		public int connectedToSlot;
		public UnityEngine.Vector3 worldSpaceLineEndRotation;
		public UnityEngine.Vector3 handlePosition;
		public UnityEngine.Vector3 handleDirection;
		public bool rootConnectionsOnly;
		public bool mainPowerSlot;
		public float lineThickness;
	}

	public class ContainerInputOutput : MonoBehaviour
	{
