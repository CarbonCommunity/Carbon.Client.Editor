...
public class BaseCardGameEntity : MonoBehaviour
{
	public int ScrapItemID;
	public float MaxStorageInteractionDist;
	...
	public class PlayerStorageInfo : MonoBehaviour
	{
	}

	public class CardGameOption : MonoBehaviour
	{
	}
