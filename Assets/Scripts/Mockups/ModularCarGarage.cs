...
public class ModularCarGarage : MonoBehaviour
{
	...
	public class ChassisBuildOption : MonoBehaviour
	{
	}

	public class OccupantLock : MonoBehaviour
	{
	}

	public class VehicleLiftState : MonoBehaviour
	{
	}
