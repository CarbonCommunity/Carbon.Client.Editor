...
public class OreHopper : MonoBehaviour
{
	public float visualPercentFull;
	public UnityEngine.Vector3 _oreScale;
	public float _clientPercentFull;
	public float ClientPercentFull;
