...
public class CoalingTower : MonoBehaviour
{
	public float vacuumStartDelay;
	public bool HasTrainCar;
	public bool HasUnloadable;
	public bool HasUnloadableLinedUp;
	...
	public class ActionAttemptStatus : MonoBehaviour
	{
	}
