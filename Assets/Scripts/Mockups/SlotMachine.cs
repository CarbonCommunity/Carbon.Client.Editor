...
public class SlotMachine : MonoBehaviour
{
	...
	public int SpinResult1;
	public int SpinResult2;
	public int SpinResult3;
	public int SpinResultPrevious1;
	public int SpinResultPrevious2;
	public int SpinResultPrevious3;
	public float SpinTime;
	public bool UseTimeOfDayAdjustedSprite;
	public float PulseSpeed;
	public float pulseFor;
	...
	public class SlotFaces : MonoBehaviour
	{
	}
