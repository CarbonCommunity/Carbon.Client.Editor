...
public class SlidingProgressDoor : MonoBehaviour
{
	public UnityEngine.Vector3 openPosition;
	public UnityEngine.Vector3 closedPosition;
	public float client_targetStoredEnergy;
