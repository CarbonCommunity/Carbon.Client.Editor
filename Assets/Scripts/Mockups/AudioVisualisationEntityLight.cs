...
public class AudioVisualisationEntityLight : MonoBehaviour
{
	public float lightMinIntensity;
	public float lightMaxIntensity;
	public float lastVolume;
	public bool ShowColourOption;
	public bool ShowSpeedOption;
	public bool ShowVolumeOption;
	public float roughPeak;
	public bool ShowPatternOption;
	public bool ShowGradientOption;
	...
	public class LightColourSet : MonoBehaviour
	{
	}
